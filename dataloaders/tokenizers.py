...
class VisualCometTokenizer(GPT2Tokenizer):
    def __init__(self,
        ...
        self.begin_attribute = begin_attribute
        ...
        self.add_special_tokens({
            "additional_special_tokens": [self.begin_img, self.end_img, self.begin_event, self.end_event,
                                          self.begin_place, self.end_place, self.end_inference, self.begin_scene, self.end_scene, self.begin_attribute, self.end_attribute]
    ...
    def decode(self, token_ids, skip_special_tokens=False, clean_up_tokenization_spaces=True):
        ...
        tokens2remove = [self.begin_img, self.end_img, self.begin_event, self.end_event,
                         self.end_place, self.end_inference, self.unk_token, self.begin_scene, self.end_scene, self.begin_attribute, self.end_attribute] + list(self.begin_inferences.values())
